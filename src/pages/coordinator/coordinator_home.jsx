...
const CoordinatorHome = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Welcome, coordinator</h1>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <button
            className="bg-gray-200 hover:bg-gray-300 p-4 rounded-lg shadow flex items-center space-x-3"
            onClick={() => navigate("/coordinator/document")}
          >
