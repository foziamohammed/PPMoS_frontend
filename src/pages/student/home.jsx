  ...
  return (
    <main className="bg-white w-full">
      ...
      <div className='flex gap-40'>
          ...
          <div className='flex gap-80'>
            <div className='flex items-center space-x-10 space-y-10 gap-20 ml-20'>
              <div className="grid place-items-center">
                <img src={user.profilePicture || 'src/assets/images/placeholder.jpg'} className="h-20 w-20 rounded-full" alt="Profile" />
                <p className='text-blue-500 font-semibold text-lg text-center'>{user.firstName} {user.lastName}</p>
              </div>
              <div className='space-y-6 text-sm'>
                <p>
                  <span className="text-blue-600 font-semibold">Department :</span> {" "}{user.department || 'School of Information Technology'}
                </p>
                <p>
                  <span className="text-blue-600 font-semibold">Program :</span> {" "}{user.program || 'PhD in Software Engineering'}
                </p>
                <p>
                  <span className="text-blue-600 font-semibold">Year :</span> {" "}{user.year || 'Year 3'}
                </p>
                <p>
                  <span className="text-blue-600 font-semibold">Research Area :</span> {" "}{user.researchArea || 'Artificial Intelligence'}
                </p>
                <p>
                  <span className="text-blue-600 font-semibold">Email :</span> {" "}{user.email || 'Not provided'}
                </p>
                <p>
                  <span className="text-blue-600 font-semibold">Phone No :</span> {" "}{user.phoneNo || 'Not provided'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-160 border rounded-lg shadow-md p-4 mt-4">
